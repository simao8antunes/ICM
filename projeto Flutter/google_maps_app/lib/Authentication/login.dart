...
import 'package:google_map_app/SQLite/databasehelper.dart';
import 'package:google_map_app/Views/google_map_page.dart';
  ...
  login() async {
    ...
    if (response == true) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => GoogleMapPage(username: username.text)));
    } else {
